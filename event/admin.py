...
from .models import Event, FormatEvent, ThemeOfEvent, City, SubscribeUser, EventComments
...
class EventCommentsConfig(admin.TabularInline):
	model = EventComments
	extra = 1
...
class EventConfig(admin.ModelAdmin):
	...
	inlines = [SubscribeUserInline, EventCommentsConfig]
